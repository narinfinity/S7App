...
using S7Test.Web.Models.Authorization;
using S7Test.Web.Models.Authorization.Attribute;
using S7Test.Core.Interface.Service.App;
using TestApp.Web.Models.Authorization;

namespace S7Test.Web.Controllers
{
    public class AuthorizationController : Controller
    {
        private readonly OpenIddictApplicationManager<OpenIddictApplication<string>> _applicationManager;
        ...
        public AuthorizationController(
            OpenIddictApplicationManager<OpenIddictApplication<string>> applicationManager,
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!result.Succeeded) { return Json(new { errors = result.Errors.Select(e => e.Description) }); }
        ...
        public async Task<IActionResult> Authorize(OpenIdConnectRequest request)
        {
            ...
            return View(new AuthzViewModel
            {
